        ...
        <div className="treatment-plans-container">
            ...
            <div className="plans-list">
                {planOrder.map(planKey => {
                    ...
                    if (!plan) return null;
                    return (
                        <div key={plan.name} className={`plan-card ${planKey}`} style={{ position: 'relative', padding: '16px' }}>
                            ...
                            <ul className="plan-steps">
                                {plan.steps?.length > 0 ? plan.steps.map((step, index) => (
                                    <li key={index}>
        ...
        <div className="simulation-results-container">
            ...
            <div className="plans-list">
                {results.map((plan, index) => {
                    ...
                    return (
                        <div key={plan.name} className={`plan-card rank-${index + 1} ${isBest ? 'best-plan' : ''}`} style={{ position: 'relative' }}>
                            {/* --- VIEW CODE BUTTON (Top Right) --- */}
                            <button 
                                onClick={() => onViewCode(plan)}
                                title="View Python Code"
                            ...
                            <div className="plan-header" style={{ 
                                ...
                                {/* Removed rank-badge div entirely */}
                                <div style={{ flex: 1 }}>
